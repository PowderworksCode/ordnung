...
```sh
git clone https://github.com/ThePowderworks/ordnung.git
...
Next, use [How to check an existing repository](/docs/how-to-guides/check-a-repository) in your own
work, or read [The Ordnung model](/docs/explanation/model) to understand the boundaries you just
encountered.
